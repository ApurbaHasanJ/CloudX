...
const JobDetails = () => {
  ...
  return (
    <div>
      ...
      {/* Body Section */}
      <section className="my-container  lg:flex justify-center items-center  gap-6 mt-28">
        ...
        <button className="btn w-full flex items-center justify-center mt-6">Apply Now</button>
        </div>
      </section>
    </div>
  );
