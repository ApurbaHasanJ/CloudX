...
const Header = () => {
  ...
  return (
    <div className="h-80 bg-blue-50 relative">
        <img className="absolute top-0 right-0" src="../assets/All Images/Vector-1.png" alt="" />
              ...
              <div className="p-5 bg-white border rounded shadow-sm">
                ...
                <nav>
                  <ul className="space-y-4">
                    ...
                    <li>
                      <Link to="/" className="inline-flex items-center">
                        <button className="btn  lg:text-xl text-base font-bold tracking-wide text-gray-800">
                          Start Applying
                        </button>
                      </Link>
                    </li>
